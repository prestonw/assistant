...
const BaseProviders = ({ displayingIn, children }) => (
	<AppCoreRoot router={Router}>
		<HistoryManager />
		<Env.Provider application={displayingIn}>{children}</Env.Provider>
	</AppCoreRoot>
);
...
export const Assistant = () => {
	...
	const showButton =
		!isAdmin && isHidden && ('admin_bar' !== hiddenAppearance || !isShowingAdminBar);
	return (
		<BaseProviders>
...
export const AssistantBeaverBuilderIFrameUIRoot = () => {
	return <div id="fl-asst-mount"></div>;
};
