				...
				{formData.map((group, index) => (
					<div
						...
						style={{
							...
							gridTemplateColumns:
								'post_type' !== formData[index].type ? '1fr 20px' : 'repeat(3, 1fr) 20px',
							margin: '5px 0',
						}}
					>
						...
						{1 < formData.length && (
							<a
								className="fluid-button fluid-appearance-transparent"
								style={{ width: '20px' }}
	...
	return (
		<>
			...
			<div style={{ margin: '5px 0' }}>
				<a className="fluid-button fluid-appearance-normal" onClick={addLocation}>
					{__('Add Rule')}
				</a>
			</div>
		</>
