...
export const Plugin = () => {
	...
	const { thumbnail, title, content, author, authorURI, pluginURI } = item;
	...
	return (
		<Page.Detail title={title} toolbarTitle={__('Plugin')} thumbnail={thumbnail && <Hero />}>
...
export const Theme = () => {
	...
	return (
		<Page toolbarTitle={__('Theme')} title={title} hero={banner && <Hero />} padY={false}>
			<div dangerouslySetInnerHTML={{ __html: content }} />
			{renderForm()}
		</Page>
	);
