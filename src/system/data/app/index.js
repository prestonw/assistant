...
import { defaultState, defaultActions, defaultReducers, defaultEffects } from './defaults';

export const registerAppStore = (args) => {
	const { key, state: initialState, cache, actions, reducers, effects, selectors } = args;
