...
export default () => {
	...
	const userHasPermission =
		userid === library.permissions.permissions_user_id && !library.permissions.owner;
			...
			{library.permissions.delete && (
				<Layout.Box>
					<Page.Section label={__('Danger Zone')}>
						...
						<p style={{ margin: '0' }}>
							{__(
								'Once a library has been deleted, it is gone forever. Please be sure you want to delete this library.',
							)}
						</p>
					</Page.Section>
