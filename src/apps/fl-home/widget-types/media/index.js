...
const Media = () => {
	...
	useEffect(() => {
		attachments()
			.findWhere({ post_mime_type: 'image', posts_per_page: 5 })
			.then(({ data }) => {
				if (data.items) {
			...
			>
				...
				>
					...
					>
						...
						/>
						<path
							d="M18.5819 20H1.82167C1.03258 20 0.554371 19.1288 0.978014 18.4631L7 9L11.375 13.7143L13.125 12.1429L19.2882 18.2921C19.9193 18.9217 19.4734 20 18.5819 20Z"
							fill="currentColor"
						/>
