...
const StatsSection = ({ ...rest }) => {
	return (
		<Section title={__('At A Glance')} className="home-stats-section" padContent={false} {...rest}>
			<Swiper>
				<CurrentlyViewing />
				<Counts />
				<Theme />
...
const CurrentlyViewing = () => {
	...
	actions = applyFilters('fl-asst.currently-viewing-actions', actions, {
		currentPageView,
		item,
		env,
	});
...
const Theme = () => {
	...
	return (
		<a
			href={adminURLs.switchThemes}
			className="fl-asst-swiper-item home-theme-card"
			target="_blank"
			rel="noreferrer"
		>
