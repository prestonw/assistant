...
const Banner = () => {
	...
	return (
		<div style={{ backgroundColor: 'var(--fl-brand-tan)' }}>
			<div
				style={{
					backgroundImage: isBBExtension
						? `url(${pluginURL}/img/apps/cloud-connect/template-cloud.jpg)`
						: `url(${pluginURL}/img/apps/cloud-connect/pro-banner-large.png)`,
				...
				{isBBExtension && (
					<>
						...
						<p style={{ textAlign: 'center' }}>
							{__('Share row and layout templates between all your sites.')}
						</p>
				...
				{!isBBExtension && (
					<>
						...
						<p style={{ marginBottom: 30 }}>
							{__(
								'Assistant Pro joins your WordPress sites together and allows you to sync creative assets, posts and layouts between them. To use libraries, you’ll need an Assistant Pro account.',
							)}
						</p>
